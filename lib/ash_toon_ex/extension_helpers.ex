defmodule AshToonEx.ExtensionHelpers do
  @moduledoc false

  def toon_section(target) do
    ...
    compact_entity = %Spark.Dsl.Entity{
      ...
      """,
      target: AshToonEx.TransformerHelpers.Step,
    ...
    order_entity = %Spark.Dsl.Entity{
      ...
      schema: [
        sort: [
          doc: """
            An order to apply to keys in toon. Accepts a boolean, a sort function or a list of keys in a desired order.
          """,
